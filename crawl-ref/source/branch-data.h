...
const Branch branches[NUM_BRANCHES] =
{
    ...
    { BRANCH_DUNGEON, NUM_BRANCHES, 0, 0, 18, 0,
      0, 0,
    ...
    { BRANCH_ELF, BRANCH_ORC, 3, 4, 5, 15,
      0, 0,
    ...
    { BRANCH_VAULTS, BRANCH_DEPTHS, 1, 4, 8, 19,
      0, 0,
    ...
    { BRANCH_FOREST, BRANCH_VAULTS, 2, 5, 5, 19,
      0, 0,
    ...
    { BRANCH_DEPTHS, BRANCH_DUNGEON, 18, 18, 9, 22,
      0, 0,
